...
As a side project I recently helped a *friend* use an [R package](https://CRAN.R-project.org/package=BIEN) for retrieving data from the Botantical Information and Ecology Network Database (BIEN). The code / output for that exploration is documented below.
