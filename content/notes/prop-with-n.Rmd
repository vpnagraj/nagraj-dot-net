...
One of the more typical workflows I need to perform is calculating counts within groups. The **dplyr** `group_by() %>% summarise()` pipeline (or just `count()`) can easily get aggregated tallies. But occassionally it's helpful to get count within group along with the proportion overall. 
